...
using XarajatBotConsole.Models;
using File = System.IO.File;
using User = XarajatBotConsole.Models.User;
...
var bot = botManager.Create("6170355270:AAEkSwDHCyOulgnAVIburvIt3qP1JCyPNao");
...
void SendMenu(User user)
{
    ...
    menuButtons.ResizeKeyboard = true;
